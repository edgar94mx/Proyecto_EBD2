...
namespace Proyecto_EBD2.Sources.Paginas
{
    public partial class FrmPerfil : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("/Sources/Paginas/FrmLogin.aspx");
            }
            else
            {
                ...
                using (SqlCommand cmd = new SqlCommand("Perfil", con))
                {
                    ...
                    if (dr.Read())
                    {
                        image.ImageUrl = "/Sources/Paginas/FrmImagen.aspx?id=" + id;
                        this.tbNombres.Text = dr["Nombres"].ToString();
                        this.tbApellidoP.Text = dr["Apellidos"].ToString();
                        this.tbApellidoM.Text = dr["Apellidos"].ToString();
