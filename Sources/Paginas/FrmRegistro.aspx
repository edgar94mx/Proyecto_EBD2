<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmRegistro.aspx.cs" Inherits="Proyecto_EBD2.Sources.Paginas.FrmRegistro" %>
                ...
                <div class="form-control card card-body">
                    ...
                    <fieldset>
                        ...
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="tbNombres" CssClass="form-control" runat="server" placeholder="Ej. Claudia"></asp:TextBox>
                        </div>
                        <br />
                        <div class="input-group">
                            <asp:Label ID="Label2" CssClass="form-control" runat="server" Text="Apellido Paterno:"></asp:Label>
                            <asp:TextBox ID="tbApellidoP" CssClass="form-control" runat="server" placeholder="Ej. Rios"></asp:TextBox>
                        </div>
                        <br />
                        <div class="input-group">
                            <asp:Label ID="Label7" CssClass="form-control" runat="server" Text="Apellidos Materno:"></asp:Label>
                            <asp:TextBox ID="tbApellidoM" CssClass="form-control" runat="server" placeholder="Ej. Martinez"></asp:TextBox>
                        </div>
                        <br />
                        <div class="input-group">
                    ...
                    <fieldset>
                        ...
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="tbUsuario" CssClass="form-control" runat="server" placeholder="Ej. ClaudiaRM95"></asp:TextBox>
                        </div>
                        <br />
                        <div class="input-group">
                            <asp:Label ID="Label5" CssClass="form-control" runat="server" Text="Contraseña:"></asp:Label>
                            <asp:TextBox ID="tbClave" CssClass="form-control" runat="server" TextMode="Password" placeholder="Escribe una Contraseña"></asp:TextBox>
                        </div>
                        <br />
                        <div class="input-group">
                            <asp:Label ID="Label6" CssClass="form-control" runat="server" Text="Repetir Contraseña:"></asp:Label>
                            <asp:TextBox ID="tbClave2" CssClass="form-control" runat="server" placeholder="Repetir Contraseña" TextMode="Password"></asp:TextBox>
                        </div>
                        <br />
                        <div class="row justify-content-center">
                            <asp:Image runat="server" CssClass="img-thumbnail" Width="150" Height="150" ImageUrl="~/Sources/Imagenes/usuario.png"/>
                        </div>
                        <div class="row justify-content-center">
